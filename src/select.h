...
#if defined ( USE_213_BWSoft ) || defined ( USE_583_BW ) || defined ( USE_583_BWR ) || \
...
// NOTE This #if conditional was originally flawed and did not let me select USE_154_BW_GREEN
/*
defined ( USE_213_BWR ) || defined ( USE_213_BWY ) || defined ( USE_154_BWY ) || \
